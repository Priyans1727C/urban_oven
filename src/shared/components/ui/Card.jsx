...
const Card = ({
  ...
  // Destructure cardDetails with default values
  const {
    id,
    name,
    price,
          ...
          <div className={`relative flex flex-col ${
            ...
            <div className={`mt-auto ${
              ...
              <div className={`flex items-center justify-between ${
                ...
                {/* Conditional Action Button - Show quantity or Add to Cart */}
                {quantity ? (
                  // If quantity exists, this is likely a cart item
